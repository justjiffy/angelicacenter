...
class FacultiesControllerTest < ActionController::TestCase
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post :create, faculty: { active: @faculty.active, bio: @faculty.bio, first_name: @faculty.first_name, img: @faculty.img, last_name: @faculty.last_name }
    end
  ...
  test "should update faculty" do
    patch :update, id: @faculty, faculty: { active: @faculty.active, bio: @faculty.bio, first_name: @faculty.first_name, img: @faculty.img, last_name: @faculty.last_name }
    assert_redirected_to faculty_path(assigns(:faculty))
  end
